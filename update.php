...
<br>
<section id="form">
<div class="body_sec">ITEM ( " UPDATE MODULE "  )</div><br>
<form name="item" action="update.php" method="POST">
...
<div class="body_sec">ITEM CATEGORY :  
                              <input type="radio" name="category" value="0" checked onclick="ChangeImg(this.value)" > FINISHED GOODS
...
<br>
	    <button type="submit" style="margin-left:39%;margin-top:0%" formaction="homepage.php">CANCEL</button>
                    <button type="submit" name="update" style="margin-left:10%;margin-top:0%" >UPDATE</button>
...
$statement="UPDATE item SET item='$item' , price='$price' , category='$category' WHERE code=$code";
